    ...
    <div class="copy">
      <div style="width: 100%; max-width: 888px; flex: 1 0 100%;">
        ...
        <div flow-cols="2" flow-cols-s="1">
          ...
          <p>Die verarbeiteten Daten beinhalten:</p>
          <ul>
            <li>Adresse des Auftraggebers</li>
            <li>Geo-referenzierte Schlagdaten inkl. Schlagumrisse</li>
            <li>Historisch angebaute Feldkulturen, inkl. Deckungsbeitrags-relevanter Parameter wie Preise, Erträge und Kosten</li>
            <li>Gegebenenfalls Invekos-Daten für den automatisierten Download des sogenannten Flächeantrags</li>
          </ul>
          <p>Wir behalten uns das Recht vor, nicht unmittelbar Personenbezogene Daten wie unter anderem</p>
          <ul>
            <li>Fruchtfolgeanteile</li>
            <li>Verteilungen der Hof-Feld-Distanzen</li>
            <li>Verteilungen der Schlagspezifischen Parameter (Bodenqualität, Humusgehalt, Bodenart)</li>
            <li>Angebaute Feldkulturen</li>
            <li>Historische Deckungsbeitrags-relevante Parameter</li>
            <li>Anbaurestriktionen und Arbeitszeitrestriktionen</li>
            <li>Theoretische Optimierungspotentiale</li>
          </ul>
          <p>
          ...
          <p>
            <a class="link" target="_blank" href="https://www.ratgeberrecht.eu/leistungen/muster-datenschutzerklaerung.html">Muster-Datenschutzerklärung</a> der <a class="link" target="_blank" href="https://www.ratgeberrecht.eu/">Anwaltskanzlei Weiß &amp; Partner</a>
          </p>
        </div>
      </div>
    </div>
